...
def get_level_config(level):
    """레벨별 설정 반환"""
    configs = {
        1: {'grid_rows': 2, 'grid_cols': 2, 'pairs': 2, 'max_failures': 5, 'bombs': 0,
        ...
        4: {'grid_rows': 4, 'grid_cols': 5, 'pairs': 8, 'max_failures': 8, 'bombs': 4,
        ...
        8: {'grid_rows': 5, 'grid_cols': 5, 'pairs': 11, 'max_failures': 10, 'bombs': 3,
            'has_ice': False, 'has_light': False, 'has_witch': False, 'has_lock': True, 'has_ball': True, 'has_joker': True},
        9: {'grid_rows': 6, 'grid_cols': 6, 'pairs': 7, 'max_failures': 8, 'bombs': 22,
            'has_ice': True, 'has_light': False, 'has_witch': False, 'has_lock': True, 'has_ball': True, 'has_joker': False},
